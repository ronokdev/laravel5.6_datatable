    ...
    <header class="header fixed-top clearfix">
            ...
            {{--<ul class="nav top-menu">--}}
                ...
                {{--<li id="header_inbox_bar" class="dropdown">--}}
                    ...
                    {{--<ul class="dropdown-menu extended inbox">--}}
                        ...
                        {{--<li>--}}
                            {{--<a href="#">--}}
                                {{--<span class="photo"><img alt="avatar" src="{{ asset('bucket_admin/images/avatar-mini.jpg') }}"></span>--}}
                                {{--<span class="subject">--}}
                        ...
                        {{--<li>--}}
                            {{--<a href="#">--}}
                                {{--<span class="photo"><img alt="avatar" src="{{ asset('bucket_admin/images/avatar-mini-2.jpg') }}"></span>--}}
                                {{--<span class="subject">--}}
                        ...
                        {{--<li>--}}
                            {{--<a href="#">--}}
                                {{--<span class="photo"><img alt="avatar" src="{{ asset('bucket_admin/images/avatar-mini-3.jpg') }}"></span>--}}
                                {{--<span class="subject">--}}
        ...
        <div class="top-nav clearfix">
            ...
            {{--<ul class="nav pull-right top-menu">--}}
                ...
                {{--<li class="dropdown">--}}
                    {{--<a data-toggle="dropdown" class="dropdown-toggle" href="#">--}}
                        {{--<img alt="" src="{{ asset('bucket_admin/images/avatar1_small.jpg') }}">--}}
